...
TEST_F(TwistGateTestSuite, remoteCmdCallback)
{
  ...
  remote_cmd.vehicle_cmd.gear_cmd.gear = CMD_GEAR_P;
  ...
  ASSERT_EQ(remote_cmd.vehicle_cmd.gear_cmd.gear
      , remote_cmd.vehicle_cmd.gear_cmd.gear);
...
TEST_F(TwistGateTestSuite, stateCallback)
{
  ...
  ASSERT_EQ(CMD_GEAR_P, tg_msg.gear_cmd.gear);
  ...
  ASSERT_EQ(CMD_GEAR_D, tg_msg.gear_cmd.gear);
